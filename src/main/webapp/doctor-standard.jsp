...
<html>
	<head>
		<title>Smart Dental:ค่า Standard</title>
					...
					<div class="uk-width-1-1 "> 
						...
						<div class="uk-grid uk-grid-small uk-form" >  
							...
							<div class="uk-width-9-10 uk-text-right">   
								...
								<span class="uk-text-bottom">สาขา : </span>
						...
						<table class="uk-table uk-table uk-table-hover uk-table-striped uk-table-condensed border-gray uk-text-nowrap ">
						    <caption>ตาราง ค่า Standard</caption>
						    <thead>
						        <tr class="hd-table"> 
						        	<th class="uk-text-center uk-width-1-10 uk-text-middle" rowspan="2">ลำดับ</th>
						        	<th class="uk-text-center uk-width-1-10 uk-text-middle" rowspan="2">แพทย์</th>
						            <th class="uk-text-center uk-width-1-10 uk-text-middle" rowspan="2">สาขา</th> 
						            <th class="uk-text-center uk-width-3-10" colspan="2">ประเภทวัน</th>  
									<th class="uk-text-center uk-width-3-10" colspan="3">ประเภทชั่วโมง</th>
						        </tr>
						        <tr class="hd-table">
						        	<th class="uk-text-center uk-width-1-10">เลือก</th>  
						    ...
						    <tbody>
						        <tr>  
						        	<td class="uk-width-1-10 uk-text-center uk-text-top" rowspan="3">1</td>
						            <td class="uk-width-1-10 uk-text-left uk-text-top" rowspan="3">พท.นรง พงศาสตรา</td> 
						            <td class="uk-width-1-10 uk-text-left">LDC ศรีนครินทร์</td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t1" ></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right" placeholder="x,xxx"></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t1" ></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-4-10 uk-text-right" placeholder="0"></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right"  placeholder="x,xxx"></td>    
						        </tr>  
						        <tr>    
						        	<td class="uk-width-1-10 uk-text-left">LDC ลาดพร้าว</td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t2" ></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right" placeholder="x,xxx"></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t2" ></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-4-10 uk-text-right" placeholder="0"></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right"  placeholder="x,xxx"></td> 
						        ...
						        <tr>    
						        	<td class="uk-width-1-10 uk-text-left">LDC สาขารามคำแหง 135</td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t3" ></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right" placeholder="x,xxx"></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t3" ></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-4-10 uk-text-right" placeholder="0"></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right"  placeholder="x,xxx"></td>   
						       	...
						       	<tr>  
						        	<td class="uk-width-1-10 uk-text-center uk-text-top" rowspan="2">2</td>
						            <td class="uk-width-2-10 uk-text-left uk-text-top" rowspan="2">พท.วัตสัน เผ่ามงคล</td> 
						            <td class="uk-width-1-10 uk-text-left">LDC ศรีนครินทร์</td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t4" ></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right" placeholder="x,xxx"></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t4" ></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-4-10 uk-text-right" placeholder="0"></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right"  placeholder="x,xxx"></td>    
						        ...
						        <tr>    
						        	<td class="uk-width-1-10 uk-text-left">LDC งามวงศ์วาน</td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t5" ></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right" placeholder="x,xxx"></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="radio" name="t5" ></td>
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-4-10 uk-text-right" placeholder="0"></td> 
						            <td class="uk-width-1-10 uk-text-center"><input type="text" id="companyid" class="uk-form-small uk-width-6-10 uk-text-right"  placeholder="x,xxx"></td> 
