...
<body>
	...
	<div class="uk-width-10-10">
		...
		<div class="uk-grid uk-grid-collapse">
			...
			<div class="uk-width-2-10 padding5 ">
				<div class="uk-grid  padding5  border-gray uk-panel-box-primary">
					<div class="uk-width-1-1 padding5 ">
						<p
							class="uk-text-center bg-gray border-gray uk-text-primary uk-text-medium">คนไข้
						</p>
			...
			<div class="uk-width-2-10 padding5 ">
				<div class="uk-grid  padding5  border-gray uk-panel-box-primary">
					<div class="uk-width-1-1 padding5  ">
						<p
							class="uk-text-center bg-gray border-gray uk-text-primary uk-text-medium">ห้อง
						</p>
												...
												<tr>
													...
													<td><a
														class="uk-button uk-button-success uk-button-mini">
															ตกลง </a> <a
														class="uk-button uk-button-danger uk-button-mini">ยกเลิก</a></td>
												</tr>
										</table>
									</div>
								</div>
			...
			<div class="uk-width-2-10 padding5 ">
				<div class="uk-grid  padding5  border-gray uk-panel-box-primary">
					<div class="uk-width-1-1 padding5 ">
						<p
							class="uk-text-center bg-gray border-gray uk-text-primary uk-text-medium">รอผลการรักษา
						</p>
						<h4 class="hd-text border-gray bg-gray padding5">
							<small class=" uk-text-primary">ชื่อแพทย์ : </small>
							<s:property value="" />
