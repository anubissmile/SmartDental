...
<html>
	<head>
		<title>Smart Dental : เพิ่มสินค้า</title>
	</head> 
	<body>
					...
					<div class="uk-grid ">
						<div class="uk-width-1-1 uk-overflow-container ">
							 <div class="uk-panel uk-panel-box uk-width-medium-1-1">
							 	<div class="uk-panel-badge uk-badge uk-badge-primary">สินค้า</div>
                                <div class="uk-panel-header">
								    <h3 class="uk-panel-title"><i class="uk-icon-cog"></i>สินค้า</h3>
								</div>
