...
<html>
	<head>
		<title>Smart Dental : เพิ่มวัสดุ</title>
		...
		<div class="uk-grid uk-grid-collapse">
			...
			<div class="uk-width-9-10">
				...
				<%@include file="backend-lab-top.jsp" %>
					...
					<form id="service" action="addMaterialInsert" method="post">
					<div class="padding5 border-gray uk-panel uk-panel-box bg-gray">
					<div class="uk-grid ">
						<div class="uk-width-1-1 uk-overflow-container ">
							 <div class="uk-panel uk-panel-box uk-width-medium-1-1">
							 	<div class="uk-panel-badge uk-badge uk-badge-primary">วัสดุ</div>
                                <div class="uk-panel-header">
								    <h3 class="uk-panel-title"><i class="uk-icon-cog"></i>วัสดุ</h3>
								</div>
