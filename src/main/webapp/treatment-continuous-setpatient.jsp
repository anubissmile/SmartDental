...
<html>
	<head>
		<title>Smart Dental:treatment-continuous</title>
		...
		<div class="uk-width-9-10">
			...
			<!-- Action error & messages -->
 			<s:form class="uk-form" 
 				action="addtreatmentcontinuouspatient" 
 				method="post" 
 				theme="simple"
				...
				<div class="uk-grid uk-grid-collapse">
					...
					<div class="uk-width-8-10">
						<div class="uk-grid uk-grid-collapse">
							...
							<div class="uk-width-1-2 uk-text-left">
								<strong class="uk-form-label">จำนวนค่ารักษาทั้งหมด</strong><br>
								<input type="text" class="uk-form-large uk-text-right" name="treatModel.treatment_price" readonly="readonly" value='<s:property value="treatModel.treatment_price" />'  />
							</div>
<%-- 								<div class="uk-width-1-1 uk-margin-top" id="ldc-wrap-accordion">
								...
								<div class="uk-accordion" 
									id="isconshow"
									data-uk-observe >
									<s:iterator value="listtreatmentcontinuous">
									<h3 class="uk-accordion-title isconshowdetail" data-showconphase="<s:property value="treatment_con_phase" />">ระยะการรักษา #<s:property value="treatment_con_phase" /></h3>
									<div class="uk-accordion-content hidden" id="isconshowdetail<s:property value="treatment_con_phase" />" >
										<div class="uk-grid uk-grid-collapse">
											<!-- Start setting price form -->
											<div class="uk-width-1-5">
												<strong class="uk-form-label">จำนวนรอบการรักษา</strong><br>
												<small class="i-count">#<s:property value="treatment_con_phase" /></small>
												<div class="uk-form-icon">
													<i class="uk-icon-stethoscope"></i>
													<input type="text" class="uk-form-small uk-text-center p-volumn" 														
														name="treatmentModel.round"
														value="<s:property value="treatment_con_countno" />" 
													/>
												</div>
											</div>
											<div class="uk-width-1-5 uk-padding-remove-horizontal">
												...
												<div class="uk-form-icon">
													...
													<input type="text" class="uk-form-small uk-text-right p-volumn" 
														
														name="treatmentModel.phasePrice"
														value="<s:property value="treatment_con_price" />" 
													/>
												</div>
											</div>
											...
											<div class="uk-width-1-5">
												...
												<div class="uk-form-icon">
													...
													<input type="text" class="uk-form-small uk-text-right p-volumn" 
														...
														value="<s:property value="treatment_con_startprice" />" 
													/>
												</div>
											</div>
											...
											<div class="uk-width-1-5">
												...
												<div class="uk-form-icon">
													...
													<input type="text" class="uk-form-small uk-text-right p-volumn" 
														...
														value="<s:property value="treatment_con_endprice" />" 
													/>
												</div>
											</div>
												...
												<div class="uk-grid uk-grid-collapse uk-margin-medium-top uk-grid-divider">
													<div class="uk-width-1-2 uk-padding-large">
														...
														<table class="uk-table uk-table-condensed ldc-tb-med">
															...
															<s:iterator value="treatModel.proModel" var="tm">
																<tr class="ldc-tr-med" id="med-instance-elem">
																	<td class="uk-text-center num-list"><s:property value="tm.product_isCheck" /></td>
																	<td class="uk-text-left">
																		<strong class="p-name"><s:property value="tm.product_phase_name" /></strong><br>
																		<small class="p-name-en"></small>
																		<input type="hidden" value="<s:property value="tm.product_phase_proid" />" 
																	...
																	<td class="uk-text-center">
																		<input type="text" class="uk-form-width-mini uk-text-center p-volumn" 
																			
																			name="productModel.product_volumn"
																			value="<s:property value="tm.product_phase_amount" />" 
																		/>
																	</td>
																	<td class="uk-text-center">
																		<input type="text" class="uk-form-width-mini uk-text-center p-volumn-free" 
																			
																			name="productModel.product_volumn_free"
																			value="<s:property value="tm.product_phase_amountfree" />" 
																		/>
																	</td>
																</tr>
																</s:iterator>
													...
													<div class="uk-width-1-2 uk-padding-large">
														...
														<table class="uk-table uk-table-condensed ldc-tb-treat">
															...
															<s:iterator value="treatModel.treatMasterModel">
																<tr class="ldc-tr-treat" id="treat-instance-elem">
																	<td class="uk-text-center treat-num-list"><s:property value="ischeck" /></td>
																	<td class="uk-text-center ldc-tbcol-detail">
																		<strong class="treat-name"><s:property value="treatment_nameth" /></strong><br>
																		<small class="treat-name-en"></small>
																		<input type="hidden" value="<s:property value="treatment_condetail_treatID" />" 
							...
							<input type="hidden" value='<s:property value="treatModel.treatment_ID" />' name="treatModel.treatment_ID" />
				...
				<form action="" id="treatment-listmodal">
					<div class="uk-width-1-1 uk-overflow-container">
						<table class="display nowrap compact stripe hover cell-border order-column" 
							...
							<tbody id="treat-list" data-treatment-id='<s:property value="treatModel.treatment_ID" />' >
		...
		$(document).ready(function(){
			$('.isconshowdetail').click(function () {
				
				var ifind = $(this).data("showconphase");
				$('#isconshowdetail'+ifind).toggle();
			});
			/**
