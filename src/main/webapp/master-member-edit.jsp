						...
						<div class="uk-width-1-1 uk-overflow-container">
								...
								<div class="uk-width-6-10 ridge">									
										...
										<div class="uk-grid ">
											<div class="uk-width-1-5 uk-form">
												<input type="checkbox"  name="" value="1"  > ความสำคัญ
											</div>
										</div>	
										<div class="uk-grid">
										...
										<div class="uk-grid mt-1">
											<div class="uk-width-1-5 uk-form">
												<input type="radio" class="checktype" name="type" value="1" checked="checked" > คนไข้ทั่วไป
											</div>
											<div class="uk-width-1-5 uk-form ">
												<input type="radio" class="checktype" name="type" value="2" > คนไข้แบบบริษัท
											</div>											
											<div class="uk-width-2-5 uk-form ">
												<input type="radio" class="checktype" name="type" value="3" > คนไข้พนักงาน																									
											</div>
										</div>
									</div>
									<div class="uk-width-2-10"></div>
							...
							<div class="uk-grid company hidden">
								...
								<div class="uk-panel-header">
									...
									<div class="uk-grid mt-1">
										<div class="uk-width-1-5 uk-form">	
											<input type="radio" class="amounttype" name="amounttype" value="1" > วางบิล	
										</div>
										<div class="uk-width-1-5 uk-form">	
											<input type="radio" class="amounttype" name="amounttype" value="2" > วงเงินทั้งบริษัท	
										</div>
										<div class="uk-width-1-5 uk-form">	
											<input type="radio" class="amounttype" name="amounttype" value="3" > วงเงินต่อบุคคล	
										</div>																	
									</div>
