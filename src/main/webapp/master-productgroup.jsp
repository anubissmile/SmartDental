...
<html>
	<head>
		<title>Smart Dental:Group</title>
	</head> 
	<body>
		<div class="uk-grid uk-grid-collapse">
			...
			<div class="uk-width-9-10">
				<%@include file="nav-top.jsp" %>
					...
					<form id="productG" action="productGroupMaster" method="post">
					<div class="uk-grid ">
								...
								<div class="uk-grid uk-form "> 
									<div class="uk-form-icon uk-width-1-4"> 
										 <i class="uk-icon-asterisk"></i>
		                             		<input type="text" name="productgroupModel.id" placeholder="รหัส" class="uk-width-1-1"
		                             			pattern="(?=.*\d).{4,}" title="กรุณาใส่รหัสให้ครบ 4 หลัก" maxlength="4" >
		                             		
	                            	</div>
	                            	<div class="uk-form-icon uk-width-1-3"> 
										 <i class="uk-icon-asterisk"></i>
		                             		<input type="text" name="productgroupModel.name" placeholder="ชื่อ" class="uk-width-1-1"> 
	                            	</div>
	                            	<div class="uk-form-icon uk-width-1-4">
									    ...
									    <tbody>
									    	 <%   
											    if(request.getAttribute("grouplist")!=null)	{
				                                	...
				                                	List <ProductgroupModel> ProductgroupModel = grouplist;
				                                	int x=0;
					            	         	 	for(ProductgroupModel pgm : ProductgroupModel){ 
					            	         	 	x++; 
				            	         	 %>
										        <tr>
					    ...
					    <div class="uk-modal-dialog uk-form " >
					        <a class="uk-modal-close uk-close"></a>
					         ...
					         <div class="uk-modal-footer uk-text-right">
					         	...
					         	<button id="updateg" name="updateg">ตกลง</button>
					         </div>
					    </div>
					</div>
					...
					<div id="delete_group" class="uk-modal ">
					    <div class="uk-modal-dialog uk-form " >
					        <a class="uk-modal-close uk-close"></a>
					         ...
					         <div class="uk-modal-footer uk-text-right">
					         	<button class="uk-modal-close">ยกเลิก</button>
					         	<button id="deleteg" name="deleteg">ตกลง</button>
					         </div>
					    </div>
					</div>
