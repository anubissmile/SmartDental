	...
	<body>
		<div  class="uk-grid ">
			<div class="uk-width-1-1 uk-text-center">
				<h2  style="margin-top: 10px;">เลือกออกใบเสร็จจากรายการรักษาทีละรายการ</h2>
			</div>
			...
			<div class="uk-width-1-1 uk-text-center">
	        	<h3 class="uk-text-primary">รายการรักษา</h3>
			</div>
		</div>
		
		<div  class="uk-grid uk-flex-middle uk-text-center" style="margin-top:5px">	
			<div class="uk-width-1-1">
	           <table  id="treTable" class="uk-table-hover uk-table-condensed">
		           	<thead>
		           		<tr class="hd-table">
		           			<th>เลือก</th>
		           			<th>รายการรักษา</th>
        ...
        <div  class="uk-grid ">
			<div class="uk-width-1-1 uk-text-center">
	        	<h3 class="uk-text-primary" >รายการสินค้า</h3>
			</div>
		</div>
        <div  class="uk-grid uk-flex-middle uk-text-center" style="margin-top:5px">	
			<div class="uk-width-1-1">
	           	<table id="proTable" class="uk-table-hover uk-table-condensed">
		           	<thead>
		           		<tr class="hd-table">
		           			<th>เลือก</th>
		           			<th>รายการสินค้า</th>
