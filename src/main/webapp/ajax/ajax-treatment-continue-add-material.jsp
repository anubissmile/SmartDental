...
<% 
	...
	if(method_type.equals("get")){ 
		...
		String product_id			= request.getParameter("mcode");
		String qty 					= "0";
		if(request.getParameter("qty")!=null&&!request.getParameter("qty").equals("")) qty = (String) request.getParameter("qty"); 
		int continue_id 			= 0; 
		...
		sql = "INSERT INTO treatcontinue_product "
				...
				+ "VALUES ("+continue_id+", "+continue_phase+", "+continue_count+", "+continue_count_all+", "+product_id+", "+qty+", '0003')" ;
