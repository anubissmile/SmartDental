		...
		<div class="uk-grid uk-grid-collapse">
			...
			<div class="uk-width-9-10">
				<%@include file="nav-top.jsp" %>
					...
					<form id="productB" action="productBrandMaster" method="post">
					<div class="uk-grid ">
								...
								<div class="uk-grid uk-form "> 
									<div class="uk-form-icon uk-width-1-4"> 
										 <i class="uk-icon-asterisk"></i>
		                             		<input type="text" name="productBrandModel.id" placeholder="รหัส" class="uk-width-1-1"
		                             			pattern="(?=.*\d).{4,}" title="กรุณาใส่รหัสให้ครบ 4 หลัก" maxlength="4" >
		                             		
	                            	</div>
	                            	<div class="uk-form-icon uk-width-1-3"> 
										 <i class="uk-icon-asterisk"></i>
		                             		<input type="text" name="productBrandModel.name" placeholder="ชื่อ" class="uk-width-1-1"> 
	                            	</div>
	                            	<div class="uk-form-icon uk-width-1-4">
									    ...
									    <tbody>
									    	 <%   
											    if(request.getAttribute("brandlist")!=null)	{
				                                	...
				                                	List <ProductBrandModel> productBrandModel = brandlist;
				                                	int x=0;
					            	         	 	for(ProductBrandModel pbm : productBrandModel){ 
					            	         	 	x++; 
				            	         	 %>
										        <tr>
										            <td class="uk-text-center"><%=x%></td>
										            <td class="uk-text-left"><%=pbm.getId()%></td>
										            <td class="uk-text-left"><%=pbm.getName()%></td>
										            <td class="uk-text-right">
										            	<a href="#update" onclick="update('<%=pbm.getId()%>','<%=pbm.getName()%>')" class="uk-button uk-button-primary uk-button-small" data-uk-modal>
															<i class="uk-icon-pencil"></i> แก้ไข
														</a>
										            	<a href="#delete_brand" onclick="delete_brand('<%=pbm.getId()%>','<%=pbm.getName()%>')" class="uk-button uk-button-danger uk-button-small" data-uk-modal>
					    ...
					    <div class="uk-modal-dialog uk-form " >
					        <a class="uk-modal-close uk-close"></a>
					         ...
					         <div class="uk-modal-footer uk-text-right">
					         	...
					         	<button id="updateb" name="updateb">ตกลง</button>
					         </div>
					    </div>
					</div>
					...
					<div id="delete_brand" class="uk-modal ">
					    <div class="uk-modal-dialog uk-form " >
					        <a class="uk-modal-close uk-close"></a>
					         ...
					         <div class="uk-modal-footer uk-text-right">
					         	<button class="uk-modal-close">ยกเลิก</button>
					         	<button id="deleteb" name="deleteb">ตกลง</button>
					         </div>
					    </div>
					</div>
